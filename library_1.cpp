...
int main(){
    ...
    cout << "The range for short int is from " << numeric_limits<short> :: min() << " to " <<numeric_limits<short> :: max() << endl;
        
    cout << "The range for unsigned short int is from " << numeric_limits<unsigned short> :: min() << " to " 
    ...
    cout << "The range(with lowest) for long double is from " << numeric_limits<long double> :: lowest() << " to "<<  numeric_limits<long double> :: max() << endl;
